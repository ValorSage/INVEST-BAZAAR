...
export const PhoneIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.211-.998-.553-1.348l-3.58-3.58c-.34-.34-.832-.553-1.348-.553h-1.372c-.516 0-.998.211-1.348.553l-1.54 1.54c-.958-.544-1.829-1.21-2.64-2.022s-1.478-1.682-2.022-2.64l1.54-1.54c.34-.34.553-.832.553-1.348V5.25c0-.516-.211-.998-.553-1.348L6.75 2.25c-.34-.34-.832-.553-1.348-.553H3.75A2.25 2.25 0 0 0 1.5 4.5v2.25Z" />
    </svg>
);
...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-1.063M15 19.128v-3.873m0 3.873a9.371 9.371 0 0 1-2.625.372 9.337 9.337 0 0 1-4.121-1.063M15 19.128v-3.873m-3.75 3.873a9.371 9.371 0 0 1-2.625-.372 9.337 9.337 0 0 1-4.121 1.063M3.75 15.255v-3.873m0 3.873a9.371 9.371 0 0 0 2.625-.372 9.337 9.337 0 0 0 4.121 1.063m-3.75-3.873a9.371 9.371 0 0 1 2.625-.372 9.337 9.337 0 0 1 4.121-1.063m0 0a9.371 9.371 0 0 0-2.625-.372 9.337 9.337 0 0 0-4.121 1.063m0 0a9.371 9.371 0 0 1-2.625.372 9.337 9.337 0 0 1-4.121-1.063M11.25 5.25a3 3 0 1 1-6 0 3 3 0 0 1 6 0m3 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0m3 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0m3 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
    </svg>
);
...
export const ReferralIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const HeadsetIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m12 0v-1.5a6 6 0 0 0-12 0v1.5m0 0H4.5m15 0H19.5m-15 0a2.25 2.25 0 0 1-2.25-2.25V9.75c0-1.244 1.006-2.25 2.25-2.25h1.5a2.25 2.25 0 0 1 2.25 2.25v3.75m15 0a2.25 2.25 0 0 0 2.25-2.25V9.75a2.25 2.25 0 0 0-2.25-2.25h-1.5a2.25 2.25 0 0 0-2.25 2.25v3.75m-7.5-3.75h.008v.008h-.008v-.008Z" />
    </svg>
);
